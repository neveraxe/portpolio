			    			...
			    			<div class="panel-body">
			    			 ...
			    			 <table class="table table-striped">
							  ...
							  <c:forEach items="${pro_list }" var="proVO">
							    <tr>
							      <th scope="row"><c:out value="${proVO.pdt_num_pk }"></c:out></th>
							      <td>
							      <a class="move" href="${proVO.pdt_num_pk }"><c:out value="${proVO.pdt_name }"></c:out></a>
							      <img src="/admin/product/displayFile?fileName=${proVO.pdt_img }">
							      </td>
							      <td><fmt:formatNumber type="currency" value="${proVO.pdt_price }"/></td>
							      ...
							      <td>
							      	<button type="button" data-pdt_num_pk="${proVO.pdt_num_pk}" class="btn btn-primary btn-edit">수정</button>
							      </td>
							      <td>
							      	<button type="button" data-pdt_num_pk="${proVO.pdt_num_pk}" data-pdt_img="${proVO.pdt_img}" class="btn btn-danger btn-del">삭제</button>
							      </td>
							    </tr>
							   </c:forEach>
							   </tbody>
...
<script>
	$(document).ready(function(){
		...
		$("table td .btn-edit").on("click", function(){
			...
			//상품번호 필드를 추가
			actionForm.append("<input type='hidden' name='pdt_num_pk' value='" + $(this).attr("data-pdt_num_pk") + "'>");
