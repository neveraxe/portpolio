				...
				<div class="container" style="width: 100%; min-width: 900px; background-color: white; font-size: 14px;" >
					<!-- Nav tabs -->
					  <ul class="nav nav-tabs">
					    <li class="nav-item">
					      <a class="nav-link active" data-toggle="tab" href="#home" id="homea">회원정보</a>
					    </li>
					    <li class="nav-item">
					    ...
					    <div id="home" class="container tab-pane active"><br>
					      <h3>회원정보</h3>
							<form id="modifyForm" action="/member/Modify" method="post">
								<div class="container" style="width: 100%; padding: 10% 5%;">
									<div class="form-group" style="width:100%;">
										<label for="inputId">아이디</label> <br> 
										<input type="text" class="form-control" id="mb_id_pk" name="mb_id_pk"
											style="max-width:540px; width:calc(100% - 100px); 
											margin-right: 5px; display: inline-block;" readonly value='<c:out value="${vo.mb_id_pk}" />'>
									</div>
									<div class="form-group">
										<label for="inputPassword">비밀번호</label> <input type="password"
											class="form-control" id="mb_passwd" name="mb_passwd" 
									...
									<div class="form-group">
										<label for="inputName">이름</label> <input type="text"
											...
											style="max-width: 630px;" value='<c:out value="${vo.mb_name}" />'>
									</div>
									<div class="form-group">
										<label for="inputNickName">닉네임</label> <input type="text"
											class="form-control" id="mb_nick" name="mb_nick"
											style="max-width: 630px;" value='<c:out value="${vo.mb_nick}" />'>
									</div>
									<div class="form-group">
										<label for="InputEmail">이메일 주소</label><br> <input type="email"
											class="form-control" id="mb_email" name="mb_email"
											value='<c:out value="${vo.mb_email}" />'
									...
									<div class="form-group">
										<label for="inputMobile">휴대폰 번호</label> <input type="tel"
											...
											style="max-width: 630px;" value='<c:out value="${vo.mb_phone}" />'>
									</div>
									<div class="form-group">
										<label for="inputAddr">주소</label> <br>
										
										<input type="text" id="sample2_postcode" name="mb_zipcode" class="form-control" 
											style="max-width: 510px; width:calc(100% - 128px); margin-right: 5px; display: inline-block;" value='<c:out value="${vo.mb_zipcode}" />' readonly>
										<input type="button" onclick="sample2_execDaumPostcode()" id="btn_postCode" class="btn btn-primary" value="우편번호 찾기"><br>
										<input type="text" id="sample2_address" name="mb_addr" class="form-control" 
											 style="max-width: 630px; margin:3px 0px;"value='<c:out value="${vo.mb_addr}" />' readonly>
										<input type="text" id="sample2_detailAddress" name="mb_addr_d" class="form-control" 
											value='<c:out value="${vo.mb_addr_d}" />' style="max-width: 630px;">
									...
									<div class="form-group">
										...
										<label><input type="radio" name="mb_accept_e" value="Y" style="margin-left: 20px;" checked="checked" <c:out value="${vo.mb_accept_e == 'Y' ? 'checked' : ''}" />> 예</label>
			      						<label><input type="radio" name="mb_accept_e" value="N" style="margin-left: 20px;" <c:out value="${vo.mb_accept_e == 'N' ? 'checked' : ''}" />> 아니오</label>
									</div>
								</div>
...
<script>
	$(document).ready(function(){
			...
			if($("a[name='menu1aa']").on("click")){	
				$("#menu1a").addClass(" active");
				$("#menu1").addClass(" active");

				$("#menu2a").removeClass(" active");
				$("#menu2").removeClass(" active");	

			} else if($("a[name='menu2aa']").on("click")){
				$("#menu1a").removeClass(" active");
				$("#menu1").removeClass(" active");
				
				$("#menu2a").addClass(" active");
