					...
					<form id="joinForm" action="/member/join" method="post">
						<div  class="container" style="width: 800px; padding: 10% 5%;">
							...
							<div class="form-group">
								...
								<button id="btn_sendAuthCode" class="btn btn-primary" type="button" >이메일 인증</button>
							...
							<div class="form-group">
								<label for="inputMobile">휴대폰 번호</label> <input type="tel"
									...
									placeholder="휴대폰 번호를 입력 해주세요" style="max-width: 630px;">
							</div>
							<div class="form-group">
