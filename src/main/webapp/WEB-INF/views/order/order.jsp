	  				...
	  				<h4>주문자 정보</h4>
	  					...
	  					<div class="form-group">
								<label for="inputName">이름</label> <input type="text"
									class="form-control" id="mb_name" name="mb_name" value="${sessionScope.loginStatus.mb_name }"
									style="max-width: 630px;">
						</div>
						<div class="form-group">
								<label for="inputAddr">주소</label> <br />
								
								<input type="text" id="sample2_postcode" name="mb_zipcode" class="form-control" value="${sessionScope.loginStatus.mb_zipcode }"
								...
								<input type="text" id="sample2_address" name="mb_addr" value="${sessionScope.loginStatus.mb_addr }" class="form-control" 
									placeholder="주소" style="max-width: 630px; margin:3px 0px;" readonly>
								<input type="text" id="sample2_detailAddress" name="mb_addr_d" value="${sessionScope.loginStatus.mb_addr_d }" class="form-control" 
						...
						<div class="form-group">
								<label for="inputMobile">휴대폰 번호</label> <input type="tel"
									class="form-control" id="mb_phone" name="mb_phone" value="${sessionScope.loginStatus.mb_phone }"
						...
						<input type="hidden" name="pdt_num_pk" value="${pdt_num_pk }">
	  					<input type="hidden" name="odr_amount" value="${odr_amount }">
	  					<input type="hidden" name="odr_price" value="${odr_price }">
						
						<div class="form-group">
								<label for="inputName">이름</label> <input type="text"
									class="form-control" id="odr_name" name="odr_name" value="${sessionScope.loginStatus.mb_name }"
						...
						<div class="form-group">
								...
								<input type="text" id="sample2_postcode" name="odr_zipcode" class="form-control" value="${sessionScope.loginStatus.mb_zipcode }"
									style="max-width: 510px; width:calc(100% - 128px); margin-right: 5px; display: inline-block;" placeholder="우편번호" readonly>
								<input type="button" onclick="sample2_execDaumPostcode()" id="btn_postCode" class="btn btn-primary" value="우편번호 찾기"><br>
								<input type="text" id="sample2_address" name="odr_addr" class="form-control" value="${sessionScope.loginStatus.mb_addr }"
									placeholder="주소" style="max-width: 630px; margin:3px 0px;" readonly>
								<input type="text" id="sample2_detailAddress" name="odr_addr_d" value="${sessionScope.loginStatus.mb_addr_d }" class="form-control" 
									placeholder="상세주소" style="max-width: 630px;">
								<input type="hidden" id="sample2_extraAddress" class="form-control" 
									placeholder="참고항목">
						...
						<div class="form-group">
							<label for="inputMobile">휴대폰 번호</label> <input type="tel"
								class="form-control" id="odr_phone" name="odr_phone" value="${sessionScope.loginStatus.mb_phone }"
								placeholder="휴대폰 번호를 입력해 주세요" style="max-width: 630px;">
