$(document).ready(function() {
	...
	$("#btn_checkId").on("click", function(){
		if($("#mb_id_pk").val()=="" || $("#mb_id_pk").val()==null){
		...
		$.ajax({
			...
			data: {mb_id_pk : mb_id_pk},  // javascript object 표현구문.www.w3school.com 참고
	...
	$("#btn_submit").on("click", function(){
		...
		var mb_id_pk = $("#mem_id");
		var mb_passwd = $("#mem_pw");
		var mb_pw_check = $("#mem_pw_check");
		var mb_name = $("#mem_name");
		var mb_nick = $("#mem_nick");
		var mb_email = $("#mem_email");
		var mb_authcode = $("#mem_authcode");
		var mb_phone = $("#mem_phone");
		var mb_zipcode = $("input[name='mem_zipcode']");
		var mb_addr = $("input[name='mem_addr']");
		var mb_addr_d = $("input[name='mem_addr_d']");
	*/
		/* 유효성 검사 */
		/*
		...
		} else if(mb_passwd.val() != mb_pw_check.val()){
		...
		} else if(mb_nick.val()==null || mb_nick.val()==""){
			alert("닉네임을 입력해주세요.");
			mb_nick.focus();
